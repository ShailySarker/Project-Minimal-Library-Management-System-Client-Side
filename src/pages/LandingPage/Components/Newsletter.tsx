        ...
        <div className="lg:px-20 md:px-12 px-6 lg:mt-20 md:mt-16 mt-14 bg-amber-100 lg:py-12 md:py-8 py-6">
            ...
            <div className="lg:mt-16 md:mt-12 mt-8 flex justify-center">
                <form className="shadow-lg rounded-xl">
                    <input className="lg:py-3 md:py-[10px] py-2 lg:px-5 md:px-4 px-3 border-2 border-amber-700 rounded-l-xl bg-white lg:w-[400px] md:w-80 w-[224px]" type="email" name="email" id="" placeholder="Enter your email ..." />
